...
public class PlayerStatsDisplay : IPlayerDisplay
{
    public void Display()
    {
        ...
        Console.WriteLine("Level: " + player.Level.ToString().Pastel("#ff52eb"));
        Console.WriteLine($"Position: ({player.Xcoordinate.ToString().Pastel("#de8ed5")} : {player.Ycoordinate.ToString().Pastel("#de8ed5")})");
        Console.WriteLine();
    }
}